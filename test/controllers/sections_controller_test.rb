...
class SectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create section" do
    assert_difference("Section.count") do
      post sections_url, params: { section: { parent_id: @section.parent_id, title: @section.title } }
    end
  ...
  test "should update section" do
    patch section_url(@section), params: { section: { parent_id: @section.parent_id, title: @section.title } }
